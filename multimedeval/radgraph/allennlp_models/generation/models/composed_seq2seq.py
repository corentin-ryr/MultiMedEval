...
from multimedeval.radgraph.allennlp_models.generation.modules.seq_decoders.seq_decoder import (
    SeqDecoder,
)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if tied_source_embedder_key:
            ...
            self._source_text_embedder._token_embedders[tied_source_embedder_key] = (
