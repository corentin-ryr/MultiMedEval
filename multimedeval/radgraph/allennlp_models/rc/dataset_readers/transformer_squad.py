...
from multimedeval.radgraph.allennlp.common.util import sanitize_wordpiece
...
from multimedeval.radgraph.allennlp.common.file_utils import (
    cached_path,
    open_compressed,
)
...
class TransformerSquadReader(DatasetReader):
    ...
    def make_instances(
        ...
        if first_answer_offset is None:
            ...
            (token_answer_span_start, token_answer_span_end), _ = (
                char_span_to_token_span(
                    [
                        (
        ...
        while True:
            ...
            if any(
                i < 0 or i >= len(tokenized_context_window)
    ...
    def text_to_instance(
        ...
        fields["context_span"] = SpanField(
            start_of_context,
            start_of_context + len(tokenized_context) - 1,
            question_field,
        )
