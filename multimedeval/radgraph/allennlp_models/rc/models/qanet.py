...
from multimedeval.radgraph.allennlp_models.rc.metrics import SquadEmAndF1
...
class QaNet(Model):
    ...
    def __init__(
        ...
        self._dropout = (
            torch.nn.Dropout(p=dropout_prob) if dropout_prob > 0 else lambda x: x
        )
