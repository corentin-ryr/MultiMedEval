...
from multimedeval.radgraph.allennlp.data.token_indexers import TokenIndexer
...
def make_coref_instance(
    ...
    if wordpiece_modeling_tokenizer is not None:
        flat_sentences_tokens, offsets = (
            wordpiece_modeling_tokenizer.intra_word_tokenize(flattened_sentences)
        )
    ...
    for sentence in sentences:
        for start, end in enumerate_spans(
            ...
            if wordpiece_modeling_tokenizer is not None:
                ...
                if start < len(
                    wordpiece_modeling_tokenizer.single_sequence_start_tokens
                ):
                    continue
