...
from multimedeval.radgraph.allennlp_models.common.ontonotes import Ontonotes
from multimedeval.radgraph.allennlp_models.coref.util import make_coref_instance
    ...
    def _read(self, file_path: str):
        ...
        for sentences in ontonotes_reader.dataset_document_iterator(file_path):
            ...
            yield self.text_to_instance(
                [s.words for s in sentences], list(clusters.values())
            )
