...
from multimedeval.radgraph.allennlp.data.fields import Field, TextField
from multimedeval.radgraph.allennlp.data.token_indexers import SingleIdTokenIndexer
