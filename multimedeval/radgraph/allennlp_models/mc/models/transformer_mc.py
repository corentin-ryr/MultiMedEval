...
import torch
from multimedeval.radgraph.allennlp.data import Vocabulary, TextFieldTensors
...
class TransformerMC(Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        from multimedeval.radgraph.allennlp.modules.seq2vec_encoders import BertPooler
    ...
    def forward(  # type: ignore
        ...
        """
        embedded_alternatives = self._text_field_embedder(
            alternatives, num_wrapping_dims=1
        )
