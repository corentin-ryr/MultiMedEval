...
def find_embedding_layer(model: torch.nn.Module) -> torch.nn.Module:
    ...
    from multimedeval.radgraph.allennlp.modules.text_field_embedders.text_field_embedder import (
        TextFieldEmbedder,
    )
    from multimedeval.radgraph.allennlp.modules.text_field_embedders.basic_text_field_embedder import (
