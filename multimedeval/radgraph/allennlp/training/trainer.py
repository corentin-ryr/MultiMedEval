...
from multimedeval.radgraph.allennlp.common.util import int_to_device
...
from multimedeval.radgraph.allennlp.common import Lazy, Registrable, Tqdm
from multimedeval.radgraph.allennlp.common import util as common_util
from multimedeval.radgraph.allennlp.common.checks import (
    ConfigurationError,
    check_for_gpu,
)
from multimedeval.radgraph.allennlp.data import DataLoader
from multimedeval.radgraph.allennlp.data.dataloader import TensorDict
from multimedeval.radgraph.allennlp.models.model import Model
from multimedeval.radgraph.allennlp.nn import util as nn_util
from multimedeval.radgraph.allennlp.training import util as training_util
from multimedeval.radgraph.allennlp.training.checkpointer import Checkpointer
from multimedeval.radgraph.allennlp.training.learning_rate_schedulers import (
    LearningRateScheduler,
)
from multimedeval.radgraph.allennlp.training.metric_tracker import MetricTracker
from multimedeval.radgraph.allennlp.training.momentum_schedulers import (
    MomentumScheduler,
)
from multimedeval.radgraph.allennlp.training.moving_average import MovingAverage
from multimedeval.radgraph.allennlp.training.optimizers import Optimizer
...
class GradientDescentTrainer(Trainer):
    ...
    def batch_outputs(
        self, batch: TensorDict, for_training: bool
    ...
    def from_partial_objects(
        ...
        tensorboard_writer_ = tensorboard_writer.construct() or TensorboardWriter(
            serialization_dir
        )
