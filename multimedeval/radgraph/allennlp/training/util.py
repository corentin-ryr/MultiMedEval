...
from multimedeval.radgraph.allennlp.common.tqdm import Tqdm
from multimedeval.radgraph.allennlp.data import Instance, Vocabulary, Batch
from multimedeval.radgraph.allennlp.data.dataset_readers import DatasetReader
from multimedeval.radgraph.allennlp.models.archival import CONFIG_NAME
...
if TYPE_CHECKING:
    from multimedeval.radgraph.allennlp.data import AllennlpDataset
    from multimedeval.radgraph.allennlp.data import AllennlpLazyDataset
...
def get_valid_tokens_mask(
    tensor: torch.LongTensor, exclude_indices: Set[int]
) -> torch.ByteTensor:
