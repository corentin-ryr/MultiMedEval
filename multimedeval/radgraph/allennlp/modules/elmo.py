...
from multimedeval.radgraph.allennlp.common import FromParams
...
from multimedeval.radgraph.allennlp.data import Instance, Token, Vocabulary
...
from multimedeval.radgraph.allennlp.modules.elmo_lstm import ElmoLstm
...
class _ElmoBiLm(torch.nn.Module):
    ...
    def create_cached_cnn_embeddings(self, tokens: List[str]) -> None:
        ...
        from multimedeval.radgraph.allennlp.modules.token_embedders import Embedding  # type: ignore
