...
from multimedeval.radgraph.allennlp.nn.initializers import block_orthogonal
from multimedeval.radgraph.allennlp.nn.util import get_dropout_mask
...
class AugmentedLSTMCell(torch.nn.Module):
    ...
    def reset_parameters(self):
        ...
        block_orthogonal(
            self.input_linearity.weight.data, [self.lstm_dim, self.embed_dim]
        )
        block_orthogonal(
            self.state_linearity.weight.data, [self.lstm_dim, self.lstm_dim]
        )
