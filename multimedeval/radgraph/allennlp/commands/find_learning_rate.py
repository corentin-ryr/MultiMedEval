...
from multimedeval.radgraph.allennlp.common import Params, Tqdm
...
from multimedeval.radgraph.allennlp.common.util import prepare_environment
...
from multimedeval.radgraph.allennlp.training import GradientDescentTrainer, Trainer
from multimedeval.radgraph.allennlp.training.util import (
...
def find_learning_rate_model(
    ...
    data_loader = DataLoader.from_params(
        dataset=train_data, params=params.pop("data_loader")
    )
