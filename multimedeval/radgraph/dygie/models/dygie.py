...
from multimedeval.radgraph.allennlp.modules.span_extractors import EndpointSpanExtractor
...
# Import submodules.
from multimedeval.radgraph.dygie.models.coref import CorefResolver
from multimedeval.radgraph.dygie.models.ner import NERTagger
from multimedeval.radgraph.dygie.models.relation import RelationExtractor
from multimedeval.radgraph.dygie.models.events import EventExtractor
...
class DyGIE(Model):
    ...
    def _get_display_metrics(target_task):
        ...
        lookup = {
            ...
            "events": [f"MEAN__{name}" for name in ["trig_class_f1", "arg_class_f1"]],
        }
