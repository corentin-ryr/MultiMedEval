...
class AdjacencyFieldAssym(Field[torch.Tensor]):
    ...
    def __init__(
        ...
        if not all(
            [
                0 <= index[1] < col_length and 0 <= index[0] < row_length
    ...
    def get_padding_lengths(self) -> Dict[str, int]:
        return {
            "num_rows": self.row_field.sequence_length(),
    ...
    def empty_field(self) -> "AdjacencyFieldAssym":
        ...
        adjacency_field = AdjacencyFieldAssym(
            empty_list,
    ...
    def __str__(self) -> str:
        ...
        return (
            f"AdjacencyFieldAssym of row length {row_length} and col length {col_length}\n"
            f"\t\twith indices:\n {formatted_indices}\n"
