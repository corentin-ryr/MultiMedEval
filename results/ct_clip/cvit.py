...
from results.ct_clip.attention import Transformer, ContinuousPositionBias
...
def gradient_penalty(images:torch.Tensor, output, weight=10):
...
class CTViT(nn.Module):
    ...
    def decode(self, tokens):
        ...
        tokens = rearrange(tokens, "(b h w) t d -> b t h w d", b=batch_size, h=h, w=w)
        ...
        tokens = rearrange(tokens, "(b t) (h w) d -> b t h w d", b=batch_size, h=h, w=w)
